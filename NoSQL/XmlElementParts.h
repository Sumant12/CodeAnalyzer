...
result in both source and target XmlParts instances sharing the same Toker2.
...
#include <fstream>
#include <vector>
#include "ITokCollection2.h"
#include "Tokenizer2.h"

class XmlParts : public ITokCollection2
{
public:
	XmlParts(Toker2* pTokr);
	XmlParts();
	~XmlParts();
	bool get();
	int length();
...
inline XmlParts::XmlParts() : pToker2(nullptr) {}
