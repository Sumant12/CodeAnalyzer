...
size_t AbstractXmlElement::tabSize = 2;
 ...
 bool AbstractXmlElement::addChild(std::shared_ptr<AbstractXmlElement> pChild) { return false; }
 bool AbstractXmlElement::removeChild(std::shared_ptr<AbstractXmlElement> pChild) { return false; }
 std::vector<AbstractXmlElement::sPtr> AbstractXmlElement::children()
{
	return std::vector<sPtr>();
}
 bool AbstractXmlElement::addAttrib(const std::string& name, const std::string& value) { return false; }
 bool AbstractXmlElement::removeAttrib(const std::string& name) { return false; }
 AbstractXmlElement::~AbstractXmlElement() {}


  std::vector<AbstractXmlElement::sPtr> DocElement::children()
 {
	 return children_;
 }
   std::string TextElement::value() { return text_; }


    std::vector<AbstractXmlElement::sPtr> TaggedElement::children()
   {
	   return children_;
   }
    std::string TaggedElement::tag() { return tag_; }
//////////////////////////////////////////////////////////////////////////
