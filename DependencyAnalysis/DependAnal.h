...
//* graph. This graph can be used by StrongComponent package for StrongComponent Analysis.
...
namespace CodeAnalysis
{
	...
	public:
		...
		std::unordered_map<std::string, std::set<std::string>> getDependencyTable();
		...
		void addDependenciesToGraph(const std::string &fileName1_, const std::string &fileName2_);
